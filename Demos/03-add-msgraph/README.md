# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="30cd9-101">Выполнение завершенного проекта</span><span class="sxs-lookup"><span data-stu-id="30cd9-101">How to run the completed project</span></span>
