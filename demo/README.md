# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="d3ee4-101">Выполнение завершенного проекта</span><span class="sxs-lookup"><span data-stu-id="d3ee4-101">How to run the completed project</span></span>
